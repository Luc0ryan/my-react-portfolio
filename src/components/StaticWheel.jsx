export default function StaticWheel() {
  return (
        <section className="w-full py-12 md:py-16 text-black font-semibold text-[clamp(2rem,6vw,3.5rem)]">
<p className="text-center md:text-left leading-[1.15] text-[clamp(2rem,6vw,3.5rem)] font-semibold">
  Designing for{" "}
  <span className="
